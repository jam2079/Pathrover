asp <- read.table("asp_data.txt")
glu <- read.table("glu_data.txt")
phe <- read.table("phe_data.txt")
arg <- read.table("arg_data.txt")
...
write.table(determine.state(asp), file="asp_symmetry.txt", row.names=FALSE, col.names=FALSE)
write.table(determine.state(glu), file="glu_symmetry.txt", row.names=FALSE, col.names=FALSE)
write.table(determine.state(arg), file="arg_symmetry.txt", row.names=FALSE, col.names=FALSE)
write.table(determine.state(phe), file="phe_symmetry.txt", row.names=FALSE, col.names=FALSE)
q()

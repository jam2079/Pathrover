...
require(fields)
require(gplots)
datfile <-paste("data/",prot,"_",state,"_",ncovmat,"_1_pairR_ALL.dat",sep="")
#pngfile <- paste("plots/",prot,"_",state,"_1_",ncovmat,"_pairR_ALL.png",sep="")
pngfile <-paste("plots3/",prot,"_",state,"_",ncovmat,"_1_pairR_ALL.png",sep="")

#if (!(file.exists(datfile)) || (file.exists(pngfile))) {next}
...
par(mar=c(3,4,3,5.5))
image(a,axes=FALSE,col=tim.colors(64),zlim=c(0,1),main=paste(prot,state,"pairwise interactions with",ncovmat,"matrices"))
